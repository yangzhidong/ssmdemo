...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#wordCount1').on('input propertychange keydown change', function() {
                if ($('#wordCount1 textarea').val().length==100){
                    $('#wordall').text("字数达到限制！");
                }else{
                    $('#wordall').text("");
                }
...
<div class="mianCont">
    <div class="top">
        <span>您好！欢迎来到17商城 请&nbsp;<a href="login.html">[登录]</a>&nbsp;<a href="html/reg.html">[注册]</a></span>
        <span class="topRight">
    ...
    <div class="lsg">
        <h1 class="logo"><a href="html/index.html"><img src="images/logo.png" width="217" height="90" /></a></h1>
    ...
    <div class="pnt">
        ...
        <div class="pntRight">
            <ul class="nav">
                <li><a href="html/index.html">商城首页</a></li>
    ...
    <div class="positions">
        当前位置：<a href="html/index.html">首页</a> &gt; <a href="vip.html">会员中心</a>
    ...
    <div class="cont">
        ...
        <div class="contRight">
            ...
            <form action="insertMessage.html" method="get" class="message">
                <div class="addList">
                    <label >用户名:</label>
                ...
                <div class="addList" style="height:105px;">
                    <label>留言内容:</label>
                    <div id="wordCount1" data-max="100">
                        <textarea rows="5" cols="29" name="content"></textarea>

                    </div>
                    <p style="color: red">${messageinfo}</p>
                    <p id="wordall" style="color: red"></p>
